...
const tags = [
  // ...tagsList,
  // { id: '1', name: '策略', parentId: 2, category: 'boardgame' },
  // { id: '2', name: '家庭', parentId: null, category: 'boardgame' },
  // { id: '3', name: '派對', parentId: 4  , category: 'boardgame' },
  // { id: '4', name: '科幻', parentId: 3, category: 'movie' },
  // { id: '5', name: '動作', parentId: 3, category: 'movie' },
  // 添加更多初始標籤...
  ...
  { id: '22', name: '推理', parentId: '21', category: 'various', description: '' },
